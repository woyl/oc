...
public class SwipeBackLayout extends FrameLayout {
    ...
    private void init() {
        ...
        setShadow(R.drawable.ic_launcher_background, EDGE_LEFT);
    ...
    public void setEdgeOrientation(int orientation) {
        ...
        if (orientation == EDGE_RIGHT || orientation == EDGE_ALL) {
            setShadow(R.drawable.ic_launcher_background, EDGE_RIGHT);
        }
    }
            ...
            if (mScrollPercent > 1) {
                if (mFragment != null) {
                    if (mPreFragment instanceof SwipeBackFragment) {
                        ((SwipeBackFragment) mPreFragment).setMLocking(true);
                    }
                    if (!mFragment.isDetached()) {
                        mFragment.setMLocking(true);
                        ...
                        mFragment.setMLocking(false);
                    }
                    if (mPreFragment instanceof SwipeBackFragment) {
                        ((SwipeBackFragment) mPreFragment).setMLocking(false);
                    }
                } else {

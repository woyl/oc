...
import com.mkr.base_oc.utils.DensityUtil;
...
public  class VerCodeInputView extends FrameLayout {
    ...
    public VerCodeInputView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        inputNum = ta.getInteger(R.styleable.VerCodeInputView_VerCodeInputView_inputNum, 6);
        inputWidth = ta.getDimensionPixelSize(R.styleable.VerCodeInputView_VerCodeInputView_inputWidth, DensityUtil.dip2px(context, 45));
        inputHeight = inputWidth;
        childPadding = ta.getDimensionPixelSize(R.styleable.VerCodeInputView_VerCodeInputView_inputPadding, DensityUtil.dip2px(context, 7.5f));
        textColor = ta.getColor(R.styleable.VerCodeInputView_VerCodeInputView_inputTxtColor, Color.parseColor("#333333"));
        textSize = ta.getDimensionPixelSize(R.styleable.VerCodeInputView_VerCodeInputView_inputTxtSize, 24);
        editTextBg = ta.getResourceId(R.styleable.VerCodeInputView_VerCodeInputView_inputBg, R.drawable.selector_bg_edit);
        inputType = ta.getInt(R.styleable.VerCodeInputView_VerCodeInputView_inputType, InputType.TYPE_CLASS_NUMBER);
        ta.recycle();
